...
| Value  | Utility               | Desktop result     |
|--------|-----------------------|--------------------|
| `none` | (none)                | No padding         |
| `xs`   | `section-padding-xs`  | `py-12` / `py-16`  |
| `sm`   | `section-padding-sm`  | `py-16` / `py-20`  |
| `md`   | `section-padding`     | `py-24` / `py-32`  |
| `lg`   | `section-padding-lg`  | `py-32` / `py-48`  |
| `xl`   | `section-padding-xl`  | `py-48` / `py-64`  |
